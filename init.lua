...
What is Kickstart?
  ...
  Kickstart.nvim is a starting point for your own configuration.
    ...
    what your configuration is doing, and modofy it to suit your needs.
...
require('lazy').setup({
  ...
  { -- Autocompletion
    ...
    config = function()
      -- See `:help cmp`
      require('luasnip.loaders.from_lua').load { paths = './lua/custom/luasnips' }
